export default {
  ...
  "detectionStrategies": "",
  "mitigationStrategies": "Cascading dependencies and improvement deadlock can be avoided if the initial model can be augmented to learn the corrections desired for the problem at hand by adding features to distinguish among the cases. Another way can be to just accept the cost of building a separate model from scratch instead of reusing an existing model.",
  "sources": [
