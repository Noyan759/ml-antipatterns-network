export default {
  ...
  "detectionStrategies": "The only way to detect skew in your system is to explicitly monitor the system and data, and look for changes in model performance and data statistics. There are tools, like Tensor Flow Extended(TFX data validation and TFX model analysis) that handles this monitoring and data change analysis job for us.",
