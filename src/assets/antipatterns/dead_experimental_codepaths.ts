export default {
  ...
  "description": "Dead experimental code-paths are connected to and are the aftermath of two other antipatterns, namely, Glue code and Pipeline jungles. Rapid prototyping is an essential part of machine learning models that requires many experiments. The iterative and experimental process results in several conditional branches consisting of experimental codepaths within the main production code. These experimental branches are with time forgotten resulting in dead code.",
  "causes": "",
  "impact": "Over time, the accumulating dead codepaths add to the technical debt of the system by making the system more difficult to maintain and an exponential increase in cyclomatic complexity[P3]. An infamous example of dead experimental code path dangers was when Knight Capital’s system lost around 456 million dollars in less than an hour due to unexpected behavior resulting due to the presence of obsolete experimental code paths.",
  ...
  "mitigationStrategies": "Most of the time only a small subset of those conditional and experimental branches are actually being used, the rest are just abandoned and should be ripped out of the system.",
  "sources": [
